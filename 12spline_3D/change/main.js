...
app.load('https://prod.spline.design/y-GW8nTzi-AveR6c/scene.splinecode')
    .then(() => {
        ...
        gsap.set(Bunny.scale,{x:1.5,y:1.5,z:1.5})
        ...
        .to(Bunny.position,{x:0,y:0,z:0},0)
        .to(Bunny.scale,{x:0.5,y:0.5,z:0.5},0)
        .to(Bunny.rotation,{x:Math.PI * 2, y:0, z:0},0)
